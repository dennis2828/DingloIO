        ...
        <div>
            ...
            <div className="mt-12">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-1">
                        <div className="w-[5px] h-[5px] rounded-full bg-softBlue"/>
                        <p className="text-[.85em]"><InfoText>100%</InfoText> widget customizibility</p>
                    </div>
                </div>
            </div>
            <div className="mt-12 flex items-center justify-between gap-10">
                ...
                <DocumentationSectionLink path={"/docs/api-reference"} icon={<Rocket className="w-6 h-6 text-softBlue"/>} title="Quickstart" label="I want to use it now"/>
            </div>
        </div>
    )
}
