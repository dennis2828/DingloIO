...
export const Project = ({project}:ProjectProps) =>{
    return (
        <Link href={`/dashboard/${project.id}`} role="div" className="cursor-pointer bg-white border-4 border-transparent hover:border-softBlue duration-150 rounded-md p-2">
